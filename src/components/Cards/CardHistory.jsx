    ...
    return (
        <Card className="mt-5">
            <div className="flex justify-between max-sm:flex-col">
                ...
                <CardContent>
                    <div className="mt-[3.20rem]">
                        <p>INV-1712938192746-41827</p>
                    </div>
                </CardContent>
                <CardFooter>
                    <Dialog>
                        <DialogTrigger>
                            <Button className="w-full text-green-600 border-2 border-green-600 hover:text-white hover:bg-green-700 focus:ring-4 focus:outline-none text-sm px-5 py-2.5 mt-6 text-center"> 
                                <FileSearch/>
                                Detail
                            </Button>
                        </DialogTrigger>
